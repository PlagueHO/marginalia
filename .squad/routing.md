...
| ----------- | ---------- | ---------- |
| Frontend / UI / React | Dinesh | Components, styling, text editor, suggestion UX, accessibility |
| Backend / API / .NET | Gilfoyle | REST APIs, Azure Functions, AI orchestration, document processing |
| Architecture / Design | Richard | System design, API contracts, cross-cutting concerns, scope decisions |
| Code review | Richard | Review PRs, check quality, suggest improvements |
| Testing / QA | Jared | Write tests, find edge cases, verify fixes, accessibility checks |
